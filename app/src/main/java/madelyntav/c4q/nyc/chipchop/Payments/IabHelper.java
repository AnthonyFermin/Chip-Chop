    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            ...
            try {
                ...
                // Verify signature
                if (!madelyntav.c4q.nyc.chipchop.Payments.Security.verifyPurchase(mSignatureBase64, purchaseData, dataSignature)) {
    ...
    int queryPurchases(Inventory inv, String itemType) throws JSONException, RemoteException {
        ...
        do {
            ...
            for (int i = 0; i < purchaseDataList.size(); ++i) {
                ...
                if (madelyntav.c4q.nyc.chipchop.Payments.Security.verifyPurchase(mSignatureBase64, purchaseData, signature)) {
